...
class PhotoVersion:
    ...
    def getFilename(self):
        return self.photo.directoryPath + os.sep + os.path.splitext(self.photo.name)[0] + " (" + self.name + ")"  + os.path.splitext(self.photo.name)[1]
...
class Photo(SQLObject):
    ...
    def getFilename(self, forceOriginal=False, version=None, cache=None):
        ...
        if self.defaultVersionId > 1 and not forceOriginal:
            ...
            return self.directoryPath + os.sep + self.name
