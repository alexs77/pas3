...
class URLopener:
    ...
    def open_local_file(self, url):
        ...
        print "in open_local_file, url:%s, host:%s, file:%s, localname:%s" % (url, host, file, localname)
        try:
...
def test(args=[]):
    if not args:
        ...
        args = [
            'file:///home/askwar/Desktop/My Pictures/Photos/Kategorien/Hochzeit/8. Feiern/c_michael_263706_038_34A.jpg'
            ]
